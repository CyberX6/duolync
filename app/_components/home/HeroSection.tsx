...
const trust = [
  ...
  { icon: Zap, value: "48h", label: "To launch" },
];
      ...
      <div className="relative container mx-auto px-4 pt-28 pb-16">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            Meet{" "}
            <span style={{ background: "linear-gradient(90deg, #f472b6, #c084fc)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
              Creators
            </span>

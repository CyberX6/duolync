      ...
      <div className="container">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
            Advanced AI safety with Duolync Shield
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-[#a7f3d0] rounded-3xl p-8 md:p-10 min-h-[220px]">
            ...
            <p className="text-gray-700 text-base leading-relaxed">
              Duolync doesn't use user content to improve AI-powered features unless that is consistent with the user's Privacy Controls. This setting is disabled for Enterprise users and cannot be turned on.
            </p>
          </div>
        </div>
      </div>

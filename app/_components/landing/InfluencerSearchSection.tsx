...
const CREATORS = [
  {
    name: "Liam S.",
    handle: "@TheTechLiam",
    meta: "Tech Reviewer · 55k · San Francisco",
    match: 91,
    img: "/creators/liam.jpg",
  },
  {
    name: "Aisha K.",
    handle: "@StyleAisha",
    meta: "Fashion & Lifestyle · 120k · Paris",
    match: 92,
    img: "/creators/aisha.jpg",
  },
  {
    name: "Marcus V.",
    handle: "@UrbanMotionMarcus",
    meta: "Videographer · 88k · Cape Town",
    match: 93,
    img: "/creators/marcus.jpg",
  },
];
          ...
          >
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-foreground">
                    Million creators you can actually reach out to
                  </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="font-semibold text-foreground">
                  For every industry, hashtag or keyword
                </p>
              </div>
            </div>
            ...
            <div className="relative bg-gradient-to-br from-primary/5 to-accent/10 rounded-3xl p-8 overflow-hidden">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  <span className="px-3 py-1.5 bg-primary text-white text-sm rounded-full">
                    Keyword ×
                  </span>
                  <span className="px-3 py-1.5 bg-green-500 text-white text-sm rounded-full">
                    # Hashtag ×
                  </span>
                  <span className="px-3 py-1.5 bg-orange-500 text-white text-sm rounded-full">
                    @ Username ×
                  </span>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  {filtered.map((creator) => (
                    ...
                    >
                      <div className="relative h-28 w-full bg-gradient-to-br from-primary/20 to-accent/20">
                        <Image
                          src={creator.img}
                          alt={creator.name}
                          fill
                        ...
                        />
                        <span className="absolute top-2 right-2 bg-white/90 text-primary text-xs font-bold px-2 py-0.5 rounded-full shadow">
                          {creator.match}% Match
                        </span>
                      </div>
                      <div className="p-2">

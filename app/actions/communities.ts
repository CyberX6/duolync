...
export async function getCommunityListsAction(): Promise<{
  ...
  try {
    ...
    console.error("[getCommunityListsAction]:", err);
    return { data: [], error: "Failed to load community lists" };
  }
}
...
export async function createCommunityListAction(
  ...
  try {
    ...
    console.error("[createCommunityListAction]:", err);
    return { data: null, error: "Failed to create community list" };
  }
}
...
export async function deleteCommunityListAction(
  ...
  try {
    ...
    console.error("[deleteCommunityListAction]:", err);
    return { error: "Failed to delete community list" };
  }
}
...
export async function addCreatorToListAction(
  ...
  try {
    ...
    console.error("[addCreatorToListAction]:", err);
    return { error: "Failed to add creator to list" };
  }
}
...
export async function removeCreatorFromListAction(
  ...
  try {
    ...
    console.error("[removeCreatorFromListAction]:", err);
    return { error: "Failed to remove creator from list" };
  }
}
